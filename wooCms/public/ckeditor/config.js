...
CKEDITOR.stylesSet.add( 'woo_style',
[
...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.toolbar_AdminFull=[
		...
		{ name: 'insert', items: [ 'Image','Flash', 'Table', 'HorizontalRule', 'Smiley', 'ckawesome', 'SpecialChar',  'PageBreak', 'Iframe','-' ] },
